package com.github.rafaelsouzaf.monitorplus.activities;
...
import com.github.rafaelsouzaf.monitorplus.R;
import com.github.rafaelsouzaf.monitorplus.adapters.ConnectionSpinnerAdapter;
import com.github.rafaelsouzaf.monitorplus.controllers.JsonDynamicallyController;
import com.github.rafaelsouzaf.monitorplus.controllers.actions.ActionBean;
import com.github.rafaelsouzaf.monitorplus.loaders.ConnectionListLoader;
import com.github.rafaelsouzaf.monitorplus.util.Util;
import com.github.rafaelsouzaf.monitorplus.views.AutoResizeTextView;
...
public class MainActivity extends AppCompatActivity implements ActionBar.OnNavigationListener, OnSessionStartedListener, OnSessionFinishedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        View addSyncButton = findViewById(R.id.sync_button);
        addSyncButton.setVisibility(View.VISIBLE);
        addSyncButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                System.out.println("TESTING addSyncButton CLICK AQUI");
            }
        });
